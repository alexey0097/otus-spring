...
import ru.diasoft.spring.homework.dto.VariantAnswerDto;
...
public class QuestionParser {
    ...
    public List<VariantAnswerDto> parseAnswers(String answersLine)  {
    ...
    public Optional<VariantAnswerDto> parseAnswer(String answerLine) {
        List<String> answerFields = Arrays.asList(answerLine.split("&"));
        if (!CollectionUtils.isEmpty(answerFields)) {
            VariantAnswerDto answer = new VariantAnswerDto();
